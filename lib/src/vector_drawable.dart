...
class DrawableRoot implements Drawable {
  ...
  /// Creates an [Image] from the content of this [DrawableRoot].
  ///
  /// Image will be scaled automatically to fit the [size]. See [Picture.toImage]
  /// for details of why this method is synchronous.
  Image toImage(Size size, {Paint background, bool scaleToDeviceRatio = true}) {
    final PictureRecorder recorder = new PictureRecorder();
    final Canvas canvas = new Canvas(recorder);
    if (scaleToDeviceRatio == true) {
